...
12. [Очереди](#Очереди)
    ...
    4. [Получить версии очереди](#Получить-версии-очереди)
...
- `statuses` - Ключ статуса задач, которые попадут в колонку. Список всех статусов
  задачи: https://tracker.yandex.ru/admin/statuses. Строка
